...
class Inventory:
    ...
    def find_item(self, item_name):
        return f"{item_name} found." if item_name in self.items else f"{item_name} not found."

    def upgrade_item(self, item_name):
        return f"Upgraded {item_name}." if item_name in self.items else f"{item_name} not found in inventory."
...
class GameActions:
    ...
    def attack_mob(self, mob_name):
        return self.mob_killed(mob_name) if mob_name == "strong_mob" else self.mob_escaped(mob_name)
...
if __name__ == "__main__":
    ...
    print(game.actions.attack_mob("strong_mob"))
