...
class EmailSystem:
    ...
    def check_message(self, sender: User, receiver: User):
        ...
        return any(email for email in messages if email['from'] == sender.email_address and 'hi' in email['content'])
...
def test_email_system():
    ...
    #reply using same send email function
