...
def validate_platform(platform):
    if platform.pictures is None:
        return False
    if platform.platform is None:
        return False
    if len(platform.pictures) == 0:
        return False
    if platform.pictures[0]["likes"] < 0:
        return False
    if platform.show_total_likes(None, platform.pictures[0]["name"]) < 0:
        return False
    if platform.pictures[0]["name"] == "":
        return False
    if platform.show_picture_details(platform.pictures[0]["name"]) == "Not found":
        return False
    if len(platform.platform) < 0:
        return False
    if platform.pictures[-1]["likes"] < 0:
        return False
    if platform.show_total_likes(None, platform.pictures[-1]["name"]) < 0:
        return False
    if platform.show_picture_details(platform.pictures[-1]["name"]) == "":
        return False
    return platform.pictures is not None
