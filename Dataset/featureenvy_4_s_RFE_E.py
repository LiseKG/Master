...
def calculate_user_worth(user, stock_system):
    ...
    print(f"Owned stocks: {user.view_portfolio()}")
    print(f"Total stocks owned: {sum(user.view_portfolio().values())}")
    print(f"Number of distinct stocks: {len(user.view_portfolio())}")
