...
def create_application_result(app: CardApplication, review_result: str) -> dict:
...
def evaluate_multiple_applications(applications):
    ...
    return [create_application_result(app, reviewer.review(app)) for app in applications]
