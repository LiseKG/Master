...
class MovieStreamingPlatform:
    ...
    def run_rental_session(self, movie_name):
        self.actions = []
        self.actions.append("session started")
        print(self.list_movies())
        self.actions.append(self.rent_movie(movie_name))
        print(self.get_movie_info(movie_name))
        self.actions.append(self.get_movie_info(movie_name))
        print(self.get_rented_movies())
        self.actions.append(str(self.get_rented_movies()))
        self.show_user_status()
        self.returned.append(movie_name)
        self.actions.append("returned " + movie_name)
        self.show_user_status()
        print(f"Total actions: {len(self.actions)}")
        print(f"Actions log: {self.actions}")
...
if __name__ == "__main__":
    ...
    platform.run_rental_session("Inception")
