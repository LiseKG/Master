...
python3 function_rf_energy.py godclass_"$VER"_s || exit 1
python3 dividefiles.py temp_e.txt || exit 1
python3 function_rf_energy.py featureenvy_"$VER"_s || exit 1
python3 dividefiles.py temp_e.txt || exit 1
python3 function_rf_energy.py longmethod_"$VER"_s|| exit 1
python3 dividefiles.py temp_e.txt || exit 1
